...
End Function
Public Function dDiff(ByVal STime As Date, ETime As Date) As String
    'Example : TimeDiff(Time, "05:45:00 PM")
    Dim TimeSecs, Hrs As Double
    Dim strSeconds As String
    Dim strMinutes As String
    ...
    strMinutes = Int((TimeSecs Mod 3600) / 60)
    strSeconds = (TimeSecs Mod 3600) Mod 60
    dDiff = IIf(Len(strHours) = 1, String(2 - Len(strHours), "0") + strHours, strHours) + ":" + String(2 - Len(strMinutes), "0") + strMinutes + ":" + String(2 - Len(strSeconds), "0") + strSeconds
End Function
...
'***************************************************************************************************************************************************************
    ...
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.09.22" Then UpdateVersion = False
...
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.09.23" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor02
...
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.10.01" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor03
...
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.10.13" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor04
...
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.10.19" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor05
...
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.10.20" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor06
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.10.20') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,10,20,'21.10.20')"
End If
'***************************************************************************************************************************************************************
'Update=07
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.10.21" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor07
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.10.21') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,10,21,'21.10.21')"
End If
'***************************************************************************************************************************************************************
'Update=08
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.10.22" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor08
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.10.22') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,10,22,'21.10.22')"
End If
'***************************************************************************************************************************************************************
'Update=09
UpdateVersion = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.10.23" Then UpdateVersion = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateVersion = True Then
Call UpdateMinor09
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.10.23') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,10,23,'21.10.23')"
End If
'***************************************************************************************************************************************************************
'Update=10
UpdateVersion = True
...
UpdateMajor = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.11.01" Then UpdateMajor = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateMajor = True And MajorFlag = True Then
Call UpdateMajor01 'Update Account Child Master ,Update Color Master
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.11.01') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,11,01,'21.11.01')"
End If
'***************************************************************************************************************************************************************
'MajorUpdate=02
UpdateMajor = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.11.02" Then UpdateMajor = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateMajor = True And MajorFlag = True Then
Call UpdateMajor02
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.11.02') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,11,02,'21.11.02')"
End If
'***************************************************************************************************************************************************************
'MajorUpdate=03
UpdateMajor = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.11.03" Then UpdateMajor = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateMajor = True And MajorFlag = True Then
Call UpdateMajor03
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.11.03') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,11,03,'21.11.03')"
End If
'***************************************************************************************************************************************************************
'MajorUpdate=04
UpdateMajor = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.11.04" Then UpdateMajor = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateMajor = True And MajorFlag = True Then
Call UpdateMajor04
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.11.04') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,11,04,'21.11.04')"
End If
'***************************************************************************************************************************************************************
'MajorUpdate=05
UpdateMajor = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.11.05" Then UpdateMajor = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateMajor = True And MajorFlag = True Then
Call UpdateMajor05
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.11.05') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,11,05,'21.11.05')"
End If
'***************************************************************************************************************************************************************
'MajorUpdate=06
UpdateMajor = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.11.06" Then UpdateMajor = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateMajor = True And MajorFlag = True Then
Call UpdateMajor06
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.11.06') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,11,06,'21.11.06')"
End If
'***************************************************************************************************************************************************************
'MajorUpdate=07
UpdateMajor = True
    If rstEasyPublishVersion.RecordCount <> 0 Then rstEasyPublishVersion.MoveFirst
    Do While Not rstEasyPublishVersion.EOF
    If Trim(rstEasyPublishVersion.Fields("Version").Value) = "21.11.07" Then UpdateMajor = False
    rstEasyPublishVersion.MoveNext
    Loop
If UpdateMajor = True And MajorFlag = True Then
Call UpdateMajor07
'EasyPublishVersion
    cnDatabase.Execute "IF EXISTS (SELECT *FROM EasyPublishVersion WHERE Version='21.11.07') Print 'Version_Exist' ELSE Insert Into EasyPublishVersion VALUES (GetDate(),21,11,07,'21.11.07')"
End If
'***************************************************************************************************************************************************************
'Common Update
    'Email
    ...
    'BookPOChild06
    cnDatabase.Execute "IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'BookPOChild06' AND COLUMN_NAME='Code') ALTER TABLE BookPOChild06 Alter COLUMN [Titles/sheet1] decimal(12, 0) ELSE Print 'Column_Not_Exist'"
    ...
    'cnDatabase.Execute "IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tmp_TeamMemberMaster' AND COLUMN_NAME='email') Print 'Column_Exist' Else ALTER TABLE dbo.Tmp_TeamMemberMaster SET (LOCK_ESCALATION = TABLE)"
    cnDatabase.Execute "IF EXISTS(SELECT * FROM dbo.Tmp_TeamMemberMaster) EXEC('INSERT INTO dbo.Tmp_TeamMemberMaster (Code, Name, PrintName, Department, Designation, LoginId, ReportingTo, CreatedBy, CreatedOn, ModifiedBy, ModifiedOn, Recordstatus, Printstatus) SELECT Code, Name, PrintName, Department, Designation, LoginId, ReportingTo, CreatedBy, CreatedOn, ModifiedBy, ModifiedOn, Recordstatus, Printstatus FROM dbo.TeamMemberMaster WITH (HOLDLOCK TABLOCKX)')"
    cnDatabase.Execute "IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'Tmp_TeamMemberMaster' AND COLUMN_NAME='email') Print 'Column_Exist' Else DROP TABLE dbo.TeamMemberMaster"
...
'AccountChild08
    ...
    cnDatabase.Execute "CREATE TABLE [AccountChild08](  [Code] [nvarchar](6) NOT NULL,[BindingType] [nvarchar](6) NOT NULL,[BinderyProcess] [nvarchar](6) NOT NULL,[CalcMode] [nvarchar](6) NOT NULL,[SizeGroup] [nvarchar](6) NOT NULL,[Fraction] [tinyint] NOT NULL,[Range] [decimal](12, 0) NOT NULL,[Rate] [decimal](12, 2) NOT NULL,[AddOnRate] [decimal](12, 2) NOT NULL DEFAULT (0),[WEF] [date] NOT NULL DEFAULT '01-APR-2021',[Type] [char](1) NOT NULL DEFAULT 'S' CONSTRAINT [FK_AccountChild08_AccountMaster_I] FOREIGN KEY([Code]) REFERENCES [AccountMaster] ([Code]) ON UPDATE CASCADE ON DELETE CASCADE, CONSTRAINT [FK_AccountChild08_GeneralMaster_II] FOREIGN KEY([BindingType]) REFERENCES [GeneralMaster] ([Code]), CONSTRAINT [FK_AccountChild08_GeneralMaster_III] FOREIGN KEY([BinderyProcess]) REFERENCES [GeneralMaster] ([Code]), CONSTRAINT [FK_AccountChild08_GeneralMaster_IV] FOREIGN KEY([CalcMode]) REFERENCES [GeneralMaster] ([Code]), " & _
...
cnDatabase.Execute "CREATE TABLE dbo.BookPOChild05(Code nvarchar(6) NOT NULL,OrderDate datetime NOT NULL,TargetDate datetime NOT NULL,Element nvarchar(6) NOT NULL,ElementPrintName nvarchar(60) NOT NULL,FinishSize nvarchar(6) NOT NULL,Size nvarchar(6) NOT NULL,DuplexPrinting bit NOT NULL,Processing nvarchar(1) NOT NULL,Ref nvarchar(40) NULL,PlateMaker nvarchar(6) NULL,ActualQuantity decimal(12, 0) NOT NULL,BillingQuantity decimal(12, 0) NOT NULL,[Pages/PrintingForm] decimal(3, 0) NOT NULL,[Pages/Form] decimal(3, 0) NOT NULL,Color nvarchar(6) NOT NULL,Pages decimal(4, 0) NOT NULL,Forms decimal(5, 2) NOT NULL,[Forms-¼] decimal(2, 0) NOT NULL,[Forms-½] decimal(2, 0) NOT NULL,[Forms-1-F&B] decimal(3, 0) NOT NULL,[Forms-1-W&T] decimal(3, 0) NOT NULL,PlateType nvarchar(6) NOT NULL,[TotalForms-¼] decimal(12, 0) NOT NULL,[TotalForms-½] decimal(12, 0) NOT NULL,[TotalForms-1-F&B] decimal(12, 0) NOT NULL,[TotalForms-1-W&T] decimal(12, 0) NOT NULL,[TotalPlates-¼] decimal(12, 0) NOT NULL," & _
                                  "[TotalPlates-½] decimal(12, 0) NOT NULL,[TotalPlates-1-F&B] decimal(12, 0) NOT NULL,[TotalPlates-1-W&T] decimal(12, 0) NOT NULL,RevisedPlates decimal(12, 0) NOT NULL,PrintRate decimal(12, 2) NOT NULL,PrintAmount decimal(12, 2) NOT NULL,PlateRate decimal(12, 2) NOT NULL,PlateAmount decimal(12, 2) NOT NULL,PaperByParty bit NOT NULL,Paper nvarchar(6) NOT NULL,RAccount nvarchar(6) NOT NULL,CutOffSize smallint NOT NULL,[PaperWastage%] decimal(4, 2) NOT NULL,PaperWastageMin smallint NOT NULL,PaperWastageFinal decimal(12, 3) NOT NULL,PaperConsumptionOther decimal(12, 3) NOT NULL,PaperConsumptionsheets decimal(12, 0) NOT NULL,PaperConsumptionKg decimal(12, 3) NOT NULL,PaperRate decimal(12, 2) NOT NULL,PaperAmount decimal(12, 2) NOT NULL,   [Forms/Sheet1] decimal(4, 2) NOT NULL,[Forms/Sheet2] decimal(4, 2) NOT NULL,Remarks nvarchar(40) NULL,BillNo nvarchar(10) NULL,BillDate datetime NULL,PBillNo nvarchar(10) NULL,PBillDate datetime NULL,Adjustment decimal(12, 2) NOT NULL, " & _
                                  "PAdjustment decimal(12, 2) NOT NULL,RAdjustment decimal(12, 2) NOT NULL,[VAT%] decimal(4, 2) NOT NULL,VAT decimal(12, 2) NOT NULL,[PVAT%] decimal(4, 2) NOT NULL,PVAT decimal(12, 2) NOT NULL,[RVAT%] decimal(4, 2) NOT NULL,RVAT decimal(12, 2) NOT NULL,BillAmount decimal(12, 2) NOT NULL,PBillAmount decimal(12, 2) NOT NULL,RBillAmount decimal(12, 2) NOT NULL,PaidAmount decimal(12, 2) NOT NULL,PPaidAmount decimal(12, 2) NOT NULL,Status nvarchar(1) NULL,Narration nvarchar(40) NULL,AdjustmentRemarks nvarchar(40) NULL,DeliveredQuantityC decimal(12, 0) NOT NULL,DeliveredQuantityB decimal(12, 0) NOT NULL,BilledMFC decimal(12, 0) NOT NULL,BilledMFB decimal(12, 0) NOT NULL " & _
                                  ...
                                  "CONSTRAINT [FK_BookPOChild05_ElementMaster_II] FOREIGN KEY([Element]) REFERENCES ElementMaster ([Code])," & _
                                  "CONSTRAINT [FK_BookPOChild05_GeneralMaster_III] FOREIGN KEY([FinishSize]) REFERENCES GeneralMaster ([Code])," & _
                                  "CONSTRAINT [FK_BookPOChild05_GeneralMaster_IV] FOREIGN KEY([Size]) REFERENCES GeneralMaster ([Code])," & _
                                  "CONSTRAINT [FK_BookPOChild05_AccountMaster_V] FOREIGN KEY([PlateMaker]) REFERENCES AccountMaster ([Code])," & _
                                  "CONSTRAINT [FK_BookPOChild05_GeneralMaster_VI] FOREIGN KEY([Color]) REFERENCES GeneralMaster ([Code])," & _
                                  "CONSTRAINT [FK_BookPOChild05_GeneralMaster_VII] FOREIGN KEY([PlateType]) REFERENCES GeneralMaster ([Code])," & _
                                  "CONSTRAINT [FK_BookPOChild05_PaperMaster_VIII] FOREIGN KEY([Paper]) REFERENCES PaperMaster ([Code])," & _
                                  "CONSTRAINT [FK_BookPOChild05_PaperMaster_IX] FOREIGN KEY([RAccount]) REFERENCES AccountMaster ([Code]))  ON [PRIMARY]"
cnDatabase.Execute "ALTER TABLE dbo.BookPOChild05 ADD CONSTRAINT DF_BookPOChild05_ElementPrintName DEFAULT ('') FOR ElementPrintName"
cnDatabase.Execute "ALTER TABLE dbo.BookPOChild05 ADD CONSTRAINT DF_BookPOChild05_DeliveredQuantityC DEFAULT ((0)) FOR DeliveredQuantityC"
cnDatabase.Execute "ALTER TABLE dbo.BookPOChild05 ADD CONSTRAINT DF_BookPOChild05_DeliveredQuantityB DEFAULT ((0)) FOR DeliveredQuantityB"
cnDatabase.Execute "ALTER TABLE dbo.BookPOChild05 ADD CONSTRAINT DF_BookPOChild05_BilledMFC DEFAULT ((0)) FOR BilledMFC"
cnDatabase.Execute "ALTER TABLE dbo.BookPOChild05 ADD CONSTRAINT DF_BookPOChild05_BilledMFB DEFAULT ((0)) FOR BilledMFB"
cnDatabase.Execute "ALTER TABLE dbo.BookPOChild05 SET (LOCK_ESCALATION = TABLE)"
cnDatabase.Execute "INSERT INTO BookPOChild05  " & _
        "SELECT DISTINCT C.[Code],[OrderDate],[TargetDate],'*00011' As [Element],'' As ElementPrintName,I.[FinishSize],[Size1] As [Size],IIF(I.[DuplexPrinting]='Y',1,0) As DuplexPrinting,[Processing],[Ref],[PlateMaker],[ActualQuantity],BillingQuantity01 As [BillingQuantity],CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/PrintingForm],CHOOSE(CONVERT(INT,FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/Form],'*23001' As [Color],[Pages1] As [Pages],[Forms1] As [Forms],[Forms1-¼] As [Forms-¼],[Forms1-½] As [Forms-½],CONVERT(INT,([Forms1-1]/2))*2 As [Forms-1-F&B],Convert(INT,(([Forms1-1]/2)-CONVERT(INT,([Forms1-1]/2)))*2) As [Forms-1-W&T],CHOOSE(CONVERT(INT,PlateType1),'*24001','*24003','*24002','*24004') as PlateType,[TotalForms1-¼] As [TotalForms-¼],[TotalForms1-½] As [TotalForms-½],Convert(INT,Convert(INT,([Forms1-1]/2))*2* BillingQuantity01/1000)  As [TotalForms-1-F&B],Convert(INT,(([Forms1-1]-(Convert(INT,([Forms1-1]/2))*2))* BillingQuantity01)/1000) As [TotalForms-1-W&T]," & _
        "[TotalPlates1-¼] As [TotalPlates-¼],[TotalPlates1-½] As [TotalPlates-½],Convert(INT,Convert(INT,([TotalPlates1-1]/1/2))*2*1) As [TotalPlates-1-F&B],Convert(INT,[TotalPlates1-1]- Convert(INT,([TotalPlates1-1]/1/2))*2*1) As [TotalPlates-1-W&T],RevisedPlates1 As RevisedPlates,PrintRate1 As PrintRate,PrintAmount1 As PrintAmount,PlateRate1 As PlateRate,PlateAmount1 As PlateAmount,PaperByParty1 As [PaperByParty],[Paper1] As [Paper],[RAccount1] As [RAccount],[CutOffSize1] As [CutOffSize],[PaperWastage1%] As [PaperWastage%],[PaperWastageMin1] As [PaperWastageMin],[PaperWastageFinal1] As [PaperWastageFinal],[PaperConsumptionOther1] As [PaperConsumptionOther],[PaperConsumptionsheets1] As [PaperConsumptionsheets],(SELECT ROUND(([Weight/Unit]/U.Value1)*[PaperConsumptionsheets1],3) FROM PaperMaster R INNER JOIN GeneralMaster U ON R.UOM=U.Code WHERE R.Code=Paper1) As [PaperConsumptionKg],[PaperRate1] As [PaperRate],[PaperAmount1] As [PaperAmount]," & _
        "[Forms/Sheet1-1] As [Forms/Sheet1],[Forms/Sheet2-1] As [Forms/Sheet2],C.[Remarks],[BillNo],[BillDate],[PBillNo],[PBillDate],[Adjustment],[PAdjustment],[RAdjustment],[VAT%],[VAT],[PVAT%],[PVAT],[RVAT%],[RVAT],[BillAmount],[PBillAmount],[RBillAmount],[PaidAmount],[PPaidAmount],[Status],C.[Narration],[AdjustmentRemarks],C.DeliveredQuantityC,C.DeliveredQuantityB,BilledMFC,BilledMFB FROM ([dbo].[BookPOChild05T] C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN BookMaster I ON P.Book=I.Code WHERE [Pages1]<>0 " & _
        "UNION ALL " & _
        "SELECT DISTINCT C.[Code],[OrderDate],[TargetDate],'*00012' As [Element],'' As ElementPrintName,I.[FinishSize],[Size2] As [Size],IIF(I.[DuplexPrinting]='Y',1,0) As DuplexPrinting,[Processing],[Ref],[PlateMaker],[ActualQuantity],BillingQuantity02 As [BillingQuantity],CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/PrintingForm],CHOOSE(CONVERT(INT,FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/Form],'*23002' As [Color],[Pages2] As [Pages],[Forms2] As [Forms],[Forms2-¼] As [Forms-¼],[Forms2-½] As [Forms-½],CONVERT(INT,([Forms2-1]/2))*2 As [Forms-2-F&B],Convert(INT,(([Forms2-1]/2)-CONVERT(INT,([Forms2-1]/2)))*2) As [Forms-1-W&T],CHOOSE(CONVERT(INT,PlateType2),'*24001','*24003','*24002','*24004') as PlateType,[TotalForms2-¼] As [TotalForms-¼],[TotalForms2-½] As [TotalForms-½],Convert(INT,Convert(INT,([Forms2-1]/2))*2* BillingQuantity02/1000)  As [TotalForms-1-F&B],Convert(INT,(([Forms2-1]-(Convert(INT,([Forms2-1]/2))*2))* BillingQuantity02)/1000) As [TotalForms-1-W&T]," & _
        "[TotalPlates2-¼] As [TotalPlates-¼],[TotalPlates2-½] As [TotalPlates-½],Convert(INT,Convert(INT,([TotalPlates2-1]/1/2))*2*1) As [TotalPlates-1-F&B],Convert(INT,[TotalPlates2-1]- Convert(INT,([TotalPlates2-1]/1/2))*2*1) As [TotalPlates-1-W&T],[RevisedPlates2] As [RevisedPlates],[PrintRate2] As [PrintRate],[PrintAmount2] As [PrintAmount],[PlateRate2] As [PlateRate],[PlateAmount2] As [PlateAmount],PaperByParty2 As [PaperByParty],[Paper2] As [Paper],[RAccount2] As [RAccount],[CutOffSize2] As [CutOffSize],[PaperWastage2%] As [PaperWastage%],[PaperWastageMin2] As [PaperWastageMin],[PaperWastageFinal2] As [PaperWastageFinal],[PaperConsumptionOther2] As [PaperConsumptionOther],[PaperConsumptionsheets2] As [PaperConsumptionsheets],(SELECT ROUND(([Weight/Unit]/U.Value1)*[PaperConsumptionsheets2],3) FROM PaperMaster R INNER JOIN GeneralMaster U ON R.UOM=U.Code WHERE R.Code=Paper2) As [PaperConsumptionKg],[PaperRate2] As [PaperRate],[PaperAmount2] As [PaperAmount]," & _
        "[Forms/Sheet1-2] As [Forms/Sheet1],[Forms/Sheet2-2] As [Forms/Sheet2],C.[Remarks],[BillNo],[BillDate],[PBillNo],[PBillDate],[Adjustment],[PAdjustment],[RAdjustment],[VAT%],[VAT],[PVAT%],[PVAT],[RVAT%],[RVAT],[BillAmount],[PBillAmount],[RBillAmount],[PaidAmount],[PPaidAmount],[Status],C.[Narration],[AdjustmentRemarks],C.DeliveredQuantityC,C.DeliveredQuantityB,BilledMFC,BilledMFB FROM ([dbo].[BookPOChild05T] C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN BookMaster I ON P.Book=I.Code WHERE [Pages2]<>0 " & _
        "UNION ALL " & _
        "SELECT DISTINCT C.[Code],[OrderDate],[TargetDate],'*00013' As [Element],'' As ElementPrintName,I.[FinishSize],[Size4] As [Size],IIF(I.[DuplexPrinting]='Y',1,0) As DuplexPrinting,[Processing],[Ref],[PlateMaker],[ActualQuantity],BillingQuantity02 As [BillingQuantity],CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/PrintingForm],CHOOSE(CONVERT(INT,FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/Form],'*23003' As [Color],[Pages4] As [Pages],[Forms4] As [Forms],[Forms4-¼] As [Forms-¼],[Forms4-½] As [Forms-½],CONVERT(INT,([Forms4-1]/2))*2 As [Forms-2-F&B],Convert(INT,(([Forms4-1]/2)-CONVERT(INT,([Forms4-1]/2)))*2) As [Forms-1-W&T],CHOOSE(CONVERT(INT,PlateType4),'*24001','*24003','*24002','*24004') as PlateType,[TotalForms4-¼] As [TotalForms-¼],[TotalForms4-½] As [TotalForms-½],Convert(INT,Convert(INT,([Forms4-1]/2))*2* BillingQuantity02/1000)  As [TotalForms-1-F&B],Convert(INT,(([Forms4-1]-(Convert(INT,([Forms4-1]/2))*2))* BillingQuantity02)/1000) As [TotalForms-1-W&T]," & _
        "[TotalPlates4-¼] As [TotalPlates-¼],[TotalPlates4-½] As [TotalPlates-½],Convert(INT,Convert(INT,([TotalPlates4-1]/1/2))*2*1) As [TotalPlates-1-F&B],Convert(INT,[TotalPlates4-1]- Convert(INT,([TotalPlates4-1]/1/2))*2*1) As [TotalPlates-1-W&T],[RevisedPlates4] As [RevisedPlates],[PrintRate4] As [PrintRate],[PrintAmount4] As [PrintAmount],[PlateRate4] As [PlateRate],[PlateAmount4] As [PlateAmount],PaperByParty4 As [PaperByParty],[Paper4] As [Paper],[RAccount4] As [RAccount],[CutOffSize4] As [CutOffSize],[PaperWastage4%] As [PaperWastage%],[PaperWastageMin4] As [PaperWastageMin],[PaperWastageFinal4] As [PaperWastageFinal],[PaperConsumptionOther4] As [PaperConsumptionOther],[PaperConsumptionsheets4] As [PaperConsumptionsheets],(SELECT ROUND(([Weight/Unit]/U.Value1)*[PaperConsumptionsheets4],3) FROM PaperMaster R INNER JOIN GeneralMaster U ON R.UOM=U.Code WHERE R.Code=Paper4) As [PaperConsumptionKg],[PaperRate4] As [PaperRate],[PaperAmount4] As [PaperAmount]," & _
        "[Forms/Sheet1-4] As [Forms/Sheet1],[Forms/Sheet2-4] As [Forms/Sheet2],C.[Remarks],[BillNo],[BillDate],[PBillNo],[PBillDate],[Adjustment],[PAdjustment],[RAdjustment],[VAT%],[VAT],[PVAT%],[PVAT],[RVAT%],[RVAT],[BillAmount],[PBillAmount],[RBillAmount],[PaidAmount],[PPaidAmount],[Status],C.[Narration],[AdjustmentRemarks],C.DeliveredQuantityC,C.DeliveredQuantityB,BilledMFC,BilledMFB FROM ([dbo].[BookPOChild05T] C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN BookMaster I ON P.Book=I.Code WHERE [Pages4]<>0 "
...
cnDatabase.Execute "IF EXISTS (SELECT *FROM INFORMATION_SCHEMA.COLUMNS WHERE  TABLE_NAME = 'BookChild05' AND COLUMN_NAME = 'Code') Print 'Col_Exist' Else CREATE TABLE dbo.BookChild05 (Code nvarchar(6) NOT NULL,Element nvarchar(6) NOT NULL,FinishSize nvarchar(6) NOT NULL,Size nvarchar(6) NOT NULL,DuplexPrinting bit NOT NULL,[Pages/PrintingForm] nvarchar(3) NOT NULL,[Pages/Form] nvarchar(3) NOT NULL,Color nvarchar(6) NOT NULL,Pages decimal(4, 0) NOT NULL,Forms decimal(5, 2) NOT NULL,[Forms-¼] decimal(2, 0) NOT NULL,[Forms-½] decimal(2, 0) NOT NULL,[Forms-1-F&B] decimal(3, 0) NOT NULL,[Forms-1-W&T] decimal(3, 0) NULL,PlateType nvarchar(6) NOT NULL,Ups decimal(4, 0) NOT NULL,BindingForms decimal(3, 0) NOT NULL,Type nvarchar(2) NOT NULL,ElementGroup nvarchar(2) NOT NULL " & _
                                  "CONSTRAINT [FK_BookChild05_BookMaster_I] FOREIGN KEY([Code]) REFERENCES [BookMaster] ([Code]) ON UPDATE CASCADE ON DELETE CASCADE,  " & _
                                  "CONSTRAINT [FK_BookChild05_ElementMaster_II] FOREIGN KEY([Element]) REFERENCES [ElementMaster] ([Code]), " & _
                                  "CONSTRAINT [FK_BookChild05_GeneralMaster_III] FOREIGN KEY([FinishSize]) REFERENCES [GeneralMaster] ([Code]), " & _
                                  "CONSTRAINT [FK_BookChild05_GeneralMaster_IV] FOREIGN KEY([Size]) REFERENCES [GeneralMaster] ([Code]), " & _
                                  "CONSTRAINT [FK_BookChild05_GeneralMaster_V] FOREIGN KEY([Color]) REFERENCES [GeneralMaster] ([Code]), " & _
                                  "CONSTRAINT [FK_BookChild05_GeneralMaster_VI] FOREIGN KEY([PlateType]) REFERENCES [GeneralMaster] ([Code])) ON [PRIMARY] "
cnDatabase.Execute "INSERT INTO BookChild05  " & _
                                    "SELECT I.Code, '*00011' AS Element,I.FinishSize,I.Size,IIF(I.[DuplexPrinting]='Y',1,0) As DuplexPrinting,CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/PrintingForm], CHOOSE(CONVERT(INT,FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/Form],'*23001' As [Color],I.OneColorPages AS pages,I.OneColorForms AS Forms,I.[OneColor¼Forms] AS [Forms-¼],I.[OneColor½Forms] AS [Forms-½],I.[OneColor1F/BForms] AS [Forms-1-F&B],I.[OneColor1W/TForms] AS [Forms-1-W&T],CHOOSE(CONVERT(INT,I.OneColorPlateType),'*24001','*24003','*24002','*24004') as PlateType,'1' As Ups,CONVERT(INT,(I.[OneColor¼Forms]+I.[OneColor½Forms]+(I.[OneColor1F/BForms]/IIF(CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2)<=12, 2,1))+I.[OneColor1W/TForms])) As BindingForms,TYPE + Convert(nvarchar, '" & ClientID & "') As Type,'1' As ElementGroup " & _
                                    "FROM BOOKMASTER I WHERE (((I.OneColorPages)<>0)) " & _
                                    "Union All " & _
                                    "SELECT I.Code, '*00012' AS Element,I.FinishSize,I.Size,IIF(I.[DuplexPrinting]='Y',1,0) As DuplexPrinting,CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/PrintingForm], CHOOSE(CONVERT(INT,FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/Form],'*23002' As [Color],I.TwoColorPages AS pages,I.TwoColorForms AS Forms,I.[TwoColor¼Forms] AS [Forms-¼],I.[TwoColor½Forms] AS [Forms-½],I.[TwoColor1F/BForms] AS [Forms-1-F&B],I.[TwoColor1W/TForms] AS [Forms-1-W&T],CHOOSE(CONVERT(INT,I.TwoColorPlateType),'*24001','*24003','*24002','*24004') as PlateType,'1' As Ups,CONVERT(INT,(I.[TwoColor¼Forms]+I.[TwoColor½Forms]+(I.[TwoColor1F/BForms]/IIF(CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2)<=12, 2,1))+I.[TwoColor1W/TForms])) As BindingForms,TYPE + Convert(nvarchar, '" & ClientID & "')  As Type,'1' As ElementGroup " & _
                                    "FROM BOOKMASTER I WHERE (((I.TwoColorPages)<>0)) " & _
                                    "Union All " & _
                                    "SELECT I.Code, '*00013' AS Element,I.FinishSize,I.Size,IIF(I.[DuplexPrinting]='Y',1,0) As DuplexPrinting,CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/PrintingForm], CHOOSE(CONVERT(INT,FormType),8, 16, 4, 12, 24, 32, 64, 6, 2) As [Pages/Form],'*23003' As [Color],I.FourColorPages AS pages,I.FourColorForms AS Forms,I.[FourColor¼Forms] AS [Forms-¼],I.[FourColor½Forms] AS [Forms-½],I.[FourColor1F/BForms] AS [Forms-1-F&B],I.[FourColor1W/TForms] AS [Forms-1-W&T],CHOOSE(CONVERT(INT,I.FourColorPlateType),'*24001','*24003','*24002','*24004') as PlateType,'1' As Ups,CONVERT(INT,(I.[FourColor¼Forms]+I.[FourColor½Forms]+(I.[FourColor1F/BForms]/IIF(CHOOSE(CONVERT(INT,I.FormType),8, 16, 4, 12, 24, 32, 64, 6, 2)<=12, 2,1))+I.[FourColor1W/TForms])) As BindingForms,TYPE + Convert(nvarchar, '" & ClientID & "')  As Type,'1' As ElementGroup " & _
...
cnDatabase.Execute "CREATE TABLE dbo.BookChild06 (Code nvarchar(6) NOT NULL,Element nvarchar(6) NOT NULL,Pages decimal(4, 0) NOT NULL,FinishSize nvarchar(6) NOT NULL,Size nvarchar(6) NOT NULL,Imposition nvarchar(1) NOT NULL,FrontPrintingType nvarchar(6) NOT NULL,BackPrintingType nvarchar(6) NOT NULL,PlateType nvarchar(6) NOT NULL,PlateTypeBack nvarchar(6) NOT NULL,[Titles/sheet1] decimal(4, 2) NOT NULL,[Sets] decimal(4, 2) NOT NULL,BindingForms decimal(4, 2) NOT NULL,Type nvarchar(2) NOT NULL,ElementGroup nvarchar(2) NOT NULL  " & _
                                  "CONSTRAINT [FK_BookChild06_BookMaster_I] FOREIGN KEY([Code]) REFERENCES [BookMaster] ([Code]) ON UPDATE CASCADE ON DELETE CASCADE,  " & _
                                  "CONSTRAINT [FK_BookChild06_ElementMaster_II] FOREIGN KEY([Element]) REFERENCES [ElementMaster] ([Code]), " & _
                                  "CONSTRAINT [FK_BookChild06_GeneralMaster_III] FOREIGN KEY([FinishSize]) REFERENCES [GeneralMaster] ([Code]), " & _
                                  "CONSTRAINT [FK_BookChild06_GeneralMaster_IV] FOREIGN KEY([Size]) REFERENCES [GeneralMaster] ([Code]), " & _
...
cnDatabase.Execute "ALTER TABLE dbo.BookChild06 ADD CONSTRAINT  DF_BookChild06_ElementGroup DEFAULT 1 FOR ElementGroup"
cnDatabase.Execute "INSERT INTO BookChild06  " & _
                                  "SELECT I.Code, '*00020' AS Element,'4' Pages,I.FinishSize,ISNULL(IIF(I.TitleSize<>'',I.TitleSize,I.Size),I.Size) AS Size,'F' As Imposition,ISNULL(CHOOSE(CONVERT(INT,I.TitleFrontColor),'*23001','*23002','*23006','*23003','*23005','*23004','*23007','*23008'),'') As FrontPrintingType,ISNULL(CHOOSE(CONVERT(INT,I.TitleBackColor),'*23001','*23002','*23006','*23003','*23005','*23004','*23007','*23008'),'') As BackPrintingType,ISNULL(CHOOSE(CONVERT(INT,I.TitlePlateType),'*24001','*24003','*24002','*24004'),'') as PlateType,ISNULL(CHOOSE(CONVERT(INT,I.TitlePlateType),'*24001','*24003','*24002','*24004'),'') as PlateTypeBack,'2' As Ups,'1' As Sets,'0' As BindingForms,TYPE+ '" & ClientID & "' As Type,'1' As ElementGroup  " & _
                                  "FROM BOOKMASTER I Where I.Code NOT IN (Select Code From BookChild06T)"
cnDatabase.Execute "INSERT INTO BookChild06  " & _
                                  "SELECT Code, Element,Pages,FinishSize,Size,Imposition,ISNULL(CHOOSE(CONVERT(INT,FrontPrintingType),'*23001','*23002','*23006','*23003','*23005','*23004','*23007','*23008'),'') As FrontPrintingType,ISNULL(CHOOSE(CONVERT(INT,BackPrintingType),'*23001','*23002','*23006','*23003','*23005','*23004','*23007','*23008'),'') As BackPrintingType,ISNULL(CHOOSE(CONVERT(INT,PlateType),'*24001','*24003','*24002','*24004'),'') as PlateType,ISNULL(CHOOSE(CONVERT(INT,PlateTypeBack),'*24001','*24003','*24002','*24004'),'') as PlateTypeBack,[Titles/sheet1] As Ups,'1' AS Sets,'0' As BindingForms,TYPE   As Type,'1' As ElementGroup  " & _
                                  "From BookChild06T"
...
Public Function UpdateMajor05() 'Update AccountChild07
    ...
    cnDatabase.Execute "CREATE TABLE dbo.AccountChild07 (Code nvarchar(6) NOT NULL,Size nvarchar(6) NOT NULL,LaminationType nvarchar(6) NOT NULL,CalcMode nvarchar(6) NOT NULL,Rate decimal(12, 4) NOT NULL,AreaRange decimal(12, 3) NOT NULL,Range decimal(12, 3) NOT NULL,WEF date NOT NULL,Type char(1) NOT NULL   " & _
                                      "CONSTRAINT [FK_AccountChild07_BookMaster_I] FOREIGN KEY([Code]) REFERENCES [AccountMaster] ([Code]) ON UPDATE CASCADE ON DELETE CASCADE,  " & _
                                      "CONSTRAINT [FK_AccountChild07_GeneralMaster_II] FOREIGN KEY([Size]) REFERENCES [GeneralMaster] ([Code]),  " & _
                                      "CONSTRAINT [FK_AccountChild07_GeneralMaster_III] FOREIGN KEY([LaminationType]) REFERENCES [GeneralMaster] ([Code]),  " & _
                                      "CONSTRAINT [FK_AccountChild07_GeneralMaster_IV] FOREIGN KEY([CalcMode]) REFERENCES [GeneralMaster] ([Code]))  ON [PRIMARY]"
    cnDatabase.Execute "ALTER TABLE dbo.AccountChild07 ADD CONSTRAINT   DF_AccountChild07_Size DEFAULT ('') FOR Size"
    cnDatabase.Execute "ALTER TABLE dbo.AccountChild07 ADD CONSTRAINT   DF_AccountChild07_AreaRange DEFAULT (0) FOR AreaRange"
    cnDatabase.Execute "ALTER TABLE dbo.AccountChild07 ADD CONSTRAINT   DF_AccountChild07_Range_I DEFAULT (0) FOR Range"
    cnDatabase.Execute "ALTER TABLE dbo.AccountChild07 ADD CONSTRAINT   DF_AccountChild07_WEF DEFAULT ('01-APR-2021') FOR WEF"
    cnDatabase.Execute "ALTER TABLE dbo.AccountChild07 ADD CONSTRAINT   DF_AccountChild07_Type DEFAULT ('S') FOR Type"
    cnDatabase.Execute "ALTER TABLE dbo.AccountChild07 SET (LOCK_ESCALATION = TABLE)"
    cnDatabase.Execute "INSERT INTO dbo.AccountChild07 Select Code,Size,LaminationType,CalcMode,Rate,(Select(Convert(decimal,Left(Name,5))*Convert(decimal,SUBSTRING(Name,7,5))) From GeneralMaster Where Code=Size) As AreaRange,Range,WEF,Type From dbo.AccountChild07T"
End Function
...
cnDatabase.Execute "CREATE TABLE dbo.BookChild08 (Code nvarchar(6) NOT NULL,ElementGroup nvarchar(2) NOT NULL,BindingType nvarchar(6) NOT NULL,BinderyProcess nvarchar(6) NOT NULL,Number decimal(7, 3) NOT NULL,Size nvarchar(6) NOT NULL,CalcMode nvarchar (6) NOT NULL,CalcValue Decimal (12,3) NOT NULL,Type char(2) NOT NULL  " & _
                                  "CONSTRAINT [FK_BookChild08_BookMaster_I] FOREIGN KEY([Code]) REFERENCES [BookMaster] ([Code]) ON UPDATE CASCADE ON DELETE CASCADE,  " & _
                                  "CONSTRAINT [FK_BookChild08_GeneralMaster_II] FOREIGN KEY([BindingType]) REFERENCES GeneralMaster ([Code]),  " & _
                                  "CONSTRAINT [FK_BookChild08_GeneralMaster_III] FOREIGN KEY([BinderyProcess]) REFERENCES GeneralMaster ([Code]),  " & _
                                  "CONSTRAINT [FK_BookChild08_GeneralMaster_IV] FOREIGN KEY([Size]) REFERENCES GeneralMaster ([Code]),  " & _
                                  "CONSTRAINT [FK_BookChild08_GeneralMaster_V] FOREIGN KEY([CalcMode]) REFERENCES GeneralMaster ([Code])) ON [PRIMARY]"
    cnDatabase.Execute "ALTER TABLE dbo.BookChild08 ADD CONSTRAINT DF_BookChild08_ElementGroup DEFAULT ((1)) FOR ElementGroup"
    cnDatabase.Execute "ALTER TABLE dbo.BookChild08 ADD CONSTRAINT DF_BookChild08_Number DEFAULT (1) FOR Number"
    cnDatabase.Execute "ALTER TABLE dbo.BookChild08 ADD CONSTRAINT DF_BookChild08_CalcValue DEFAULT (0) FOR CalcValue"
    cnDatabase.Execute "ALTER TABLE dbo.BookChild08 SET (LOCK_ESCALATION = TABLE)"
    cnDatabase.Execute "INSERT INTO dbo.BookChild08  " & _
                                      "Select DISTINCT P.Book As Code,'1' As ElementGroup,C.BindingType,'*07039' AS BinderyProcess,(BindingForms+ExtraForms) As Number,I.FinishSize As Size,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,P.Type As Type From BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where FormFoldRate<>0  " & _
                                      "Union All  " & _
                                      "Select DISTINCT P.Book As Code,'1' As ElementGroup,C.BindingType,'*07037' AS BinderyProcess,(BindingForms+ExtraForms) As Number,I.FinishSize As Size,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,P.Type As Type From BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where FormStitchRate<>0  " & _
                                      "Union All  " & _
                                      "Select DISTINCT P.Book As Code,'1' As ElementGroup,C.BindingType,'*07038' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,P.Type As Type From BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where FormPasteRate<>0  " & _
                                      "Union All  " & _
                                      "Select DISTINCT P.Book As Code,'1' As ElementGroup,C.BindingType,'*07036' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,P.Type As Type From BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where [Rate/Book]<>0  " & _
                                      "Union All  " & _
                                      "Select DISTINCT P.Book As Code,'1' As ElementGroup,C.BindingType,'*07040' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,P.Type As Type From BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where C.PktPackRate<>0  " & _
                                      "Union All  " & _
                                      "Select DISTINCT P.Book As Code,'1' As ElementGroup,C.BindingType,'*07041' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,P.Type As Type From BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where C.BoxPackRate<>0  " & _
                                      "Union All  " & _
                                      "Select DISTINCT P.Book As Code,'1' As ElementGroup,C.BindingType,'*07042' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,P.Type As Type From BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where C.CartageRate<>0  " & _
                                      "Order By Code,BinderyProcess"
    cnDatabase.Execute "INSERT INTO dbo.BookChild08 " & _
                                      "Select DISTINCT I.Code As Code,'1' As ElementGroup,IIF(I.BindingType='','*06017',I.BindingType) As BindingType,'*07039' AS BinderyProcess,(I.BindingForms01+I.BindingForms02) As Number,I.FinishSize As Size,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,I.TYPE + Convert(nvarchar, '" & ClientID & "')  As Type From BookMaster I  Where I.Code Not IN (Select Distinct Code From BookChild08) " & _
                                      "Union All " & _
                                      "Select DISTINCT I.Code As Code,'1' As ElementGroup,IIF(I.BindingType='','*06017',I.BindingType) As BindingType,'*07037' AS BinderyProcess,(I.BindingForms01+I.BindingForms02) As Number,I.FinishSize As Size,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,I.TYPE + Convert(nvarchar, '" & ClientID & "')  As Type From BookMaster I  Where I.Code Not IN (Select Distinct Code From BookChild08) " & _
                                      "Union All " & _
                                      "Select DISTINCT I.Code As Code,'1' As ElementGroup,IIF(I.BindingType='','*06017',I.BindingType) As BindingType,'*07038' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,I.TYPE + Convert(nvarchar, '" & ClientID & "')  As Type From BookMaster I  Where I.Code Not IN (Select Distinct Code From BookChild08) " & _
                                      "Union All " & _
                                      "Select DISTINCT I.Code As Code,'1' As ElementGroup,IIF(I.BindingType='','*06017',I.BindingType) As BindingType,'*07036' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,I.TYPE + Convert(nvarchar, '" & ClientID & "')  As Type From BookMaster I  Where I.Code Not IN (Select Distinct Code From BookChild08) " & _
                                      "Union All " & _
                                      "Select DISTINCT I.Code As Code,'1' As ElementGroup,IIF(I.BindingType='','*06017',I.BindingType) As BindingType,'*07040' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,I.TYPE + Convert(nvarchar, '" & ClientID & "')  As Type From BookMaster I  Where I.Code Not IN (Select Distinct Code From BookChild08) " & _
                                      "Union All " & _
                                      "Select DISTINCT I.Code As Code,'1' As ElementGroup,IIF(I.BindingType='','*06017',I.BindingType) As BindingType,'*07041' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,I.TYPE + Convert(nvarchar, '" & ClientID & "')  As Type From BookMaster I  Where I.Code Not IN (Select Distinct Code From BookChild08) " & _
                                      "Union All " & _
                                      "Select DISTINCT I.Code As Code,'1' As ElementGroup,IIF(I.BindingType='','*06017',I.BindingType) As BindingType,'*07042' AS BinderyProcess,(1) As Number,I.FinishSize As Size,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,I.TYPE + Convert(nvarchar, '" & ClientID & "')  As Type From BookMaster I  Where I.Code Not IN (Select Distinct Code From BookChild08) " & _
                                      "Order By Code,BinderyProcess"
End Function
Public Function UpdateMajor07() 'Update BookPOChild08
    ...
    cnDatabase.Execute "CREATE TABLE dbo.BookPOChild08 (Code nvarchar(6) NOT NULL,OrderDate datetime NOT NULL,TargetDate datetime NOT NULL,ElementGroup nvarchar(2) NOT NULL,BindingType nvarchar(6) NOT NULL,BinderyProcess nvarchar(6) NOT NULL,Number decimal(7, 3) NOT NULL,Size nvarchar(6) NOT NULL,Quantity decimal(12, 3) NOT NULL,CalcMode nvarchar (6) NOT NULL,CalcValue Decimal (12,3) NOT NULL,Rate decimal(12, 3) NOT NULL,Amount decimal(12, 2) NOT NULL,Adjustment decimal(12, 2) NOT NULL,[VAT%] decimal(4, 2) NOT NULL,VAT decimal(12, 2) NOT NULL,BillAmount decimal(12, 2) NOT NULL,Remarks nvarchar(80) NULL,BillNo nvarchar(10) NULL,BillDate datetime NULL,PaidAmount decimal(12, 2) NOT NULL,Status nvarchar(1) NULL,Narration nvarchar(80) NULL,DNDetails nvarchar(80) NULL,CNDetails nvarchar(80) NULL,BillFeedDate datetime NULL,AdjustmentRemarks nvarchar(40) NULL,ComputerName nvarchar(40) NULL, " & _
                                      "DeliveredQuantityC decimal(12, 0) NOT NULL,DeliveredQuantityB decimal(12, 0) NOT NULL,BilledBNC decimal(12, 0) NOT NULL,BilledBNB decimal(12, 0) NOT NULL " & _
                                      ...
                                      "CONSTRAINT [FK_BookPOChild08_GeneralMaster_II] FOREIGN KEY([BindingType]) REFERENCES GeneralMaster ([Code]),  " & _
                                      "CONSTRAINT [FK_BookPOChild08_GeneralMaster_III] FOREIGN KEY([BinderyProcess]) REFERENCES GeneralMaster ([Code]),  " & _
                                      "CONSTRAINT [FK_BookPOChild08_GeneralMaster_IV] FOREIGN KEY([Size]) REFERENCES GeneralMaster ([Code]),  " & _
                                      "CONSTRAINT [FK_BookPOChild08_GeneralMaster_V] FOREIGN KEY([CalcMode]) REFERENCES GeneralMaster ([Code])) ON [PRIMARY]"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 ADD CONSTRAINT DF_BookPOChild08_ElementGroup DEFAULT ((1)) FOR ElementGroup"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 ADD CONSTRAINT DF_BookPOChild08_Number DEFAULT (1) FOR Number"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 ADD CONSTRAINT DF_BookPOChild08_CalcValue DEFAULT (0) FOR CalcValue"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 ADD CONSTRAINT DF_BookPOChild08_DeliveredQuantityC DEFAULT ((0)) FOR DeliveredQuantityC"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 ADD CONSTRAINT DF_BookPOChild08_DeliveredQuantityB DEFAULT ((0)) FOR DeliveredQuantityB"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 ADD CONSTRAINT DF_BookPOChild08_BilledBNC DEFAULT ((0)) FOR BilledBNC"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 ADD CONSTRAINT DF_BookPOChild08_BilledBNB DEFAULT ((0)) FOR BilledBNB"
    cnDatabase.Execute "ALTER TABLE dbo.BookPOChild08 SET (LOCK_ESCALATION = TABLE)"
    cnDatabase.Execute "INSERT INTO dbo.BookPOChild08  " & _
    "Select C.Code,OrderDate,TargetDate,'1' As ElementGroup,C.BindingType,'*07039' AS BinderyProcess,(BindingForms+ExtraForms) As Number,I.Size As Size,ActualQuantity As Quantity,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,FormFoldRate As Rate,((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormFoldRate*(BindingForms+ExtraForms))) As Amount,'0' AS Adjustment,[VAT%],(((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormFoldRate*(BindingForms+ExtraForms)))*[VAT%])/100 As VAT,(((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormFoldRate*(BindingForms+ExtraForms)))*([VAT%]+100))/100 As BillAmount,C.Remarks,BillNo,BillDate,PaidAmount,Status,C.Narration,DNDetails,CNDetails,BillFeedDate,AdjustmentRemarks,C.ComputerName,C.DeliveredQuantityC,C.DeliveredQuantityB,BilledBNC,BilledBNB " & _
    ...
    "Union All  " & _
    "Select C.Code,OrderDate,TargetDate,'1' As ElementGroup,C.BindingType,'*07037' AS BinderyProcess,(BindingForms+ExtraForms) As Number,I.Size As Size,ActualQuantity As Quantity,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20005') As CalcValue,FormStitchRate As Rate,((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormStitchRate*(BindingForms+ExtraForms))) As Amount,'0' AS Adjustment,[VAT%],((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormStitchRate*(BindingForms+ExtraForms)))*[VAT%]/100 As  VAT,(((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormStitchRate*(BindingForms+ExtraForms)))*([VAT%]+100))/100 As BillAmount,C.Remarks,BillNo,BillDate,PaidAmount,Status,C.Narration,DNDetails,CNDetails,BillFeedDate,AdjustmentRemarks,C.ComputerName,C.DeliveredQuantityC,C.DeliveredQuantityB,BilledBNC,BilledBNB " & _
    ...
    "Union All  " & _
    "Select C.Code,OrderDate,TargetDate,'1' As ElementGroup,C.BindingType,'*07038' AS BinderyProcess,1 As Number,I.Size As Size,ActualQuantity As Quantity,'*20005' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,FormPasteRate As Rate,((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormPasteRate)) As Amount,'0' AS Adjustment,[VAT%],(((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormPasteRate))*[VAT%])/100 As VAT,(((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20005')*FormPasteRate))*([VAT%]+100))/100 As BillAmount,C.Remarks,BillNo,BillDate,PaidAmount,Status,C.Narration,DNDetails,CNDetails,BillFeedDate,AdjustmentRemarks,C.ComputerName,C.DeliveredQuantityC,C.DeliveredQuantityB,BilledBNC,BilledBNB From BookPOChild08T C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where FormPasteRate<>0  " & _
    "Union All  " & _
    "Select C.Code,OrderDate,TargetDate,'1' As ElementGroup,C.BindingType,'*07036' AS BinderyProcess,1 As Number,I.Size As Size,ActualQuantity As Quantity,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,[Rate/Book] As Rate,((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20001')*[Rate/Book])) As Amount,'0' AS Adjustment,[VAT%],(((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20001')*[Rate/Book]))*[VAT%])/100 As VAT,(((BillingQuantity/(Select Value1 From GeneralMaster Where Code='*20001')*[Rate/Book]))*([VAT%]+100))/100 As BillAmount,C.Remarks,BillNo,BillDate,PaidAmount,Status,C.Narration,DNDetails,CNDetails,BillFeedDate,AdjustmentRemarks,C.ComputerName,C.DeliveredQuantityC,C.DeliveredQuantityB,BilledBNC,BilledBNB From BookPOChild08T C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where [Rate/Book]<>0  " & _
    "Union All  " & _
    "Select C.Code,OrderDate,TargetDate,'1' As ElementGroup,C.BindingType,'*07040' AS BinderyProcess,1 As Number,I.Size As Size,TotalPkts As Quantity,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,PktPackRate As Rate,((TotalPkts/(Select Value1 From GeneralMaster Where Code='*20001')*PktPackRate)) As Amount,'0' AS Adjustment,[VAT%],(((TotalPkts/(Select Value1 From GeneralMaster Where Code='*20001')*PktPackRate))*[VAT%])/100 As VAT,(((TotalPkts/(Select Value1 From GeneralMaster Where Code='*20001')*PktPackRate))*([VAT%]+100))/100 As BillAmount,C.Remarks,BillNo,BillDate,PaidAmount,Status,C.Narration,DNDetails,CNDetails,BillFeedDate,AdjustmentRemarks,C.ComputerName,C.DeliveredQuantityC,C.DeliveredQuantityB,BilledBNC,BilledBNB From BookPOChild08T C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where PktPackRate<>0  " & _
    "Union All  " & _
    "Select C.Code,OrderDate,TargetDate,'1' As ElementGroup,C.BindingType,'*07041' AS BinderyProcess,1 As Number,I.Size As Size,TotalBoxes As Quantity,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,BoxPackRate As Rate,((TotalBoxes/(Select Value1 From GeneralMaster Where Code='*20001')*BoxPackRate)) As Amount,'0' AS Adjustment,[VAT%],(((TotalBoxes/(Select Value1 From GeneralMaster Where Code='*20001')*BoxPackRate))*[VAT%])/100 As VAT,(((TotalBoxes/(Select Value1 From GeneralMaster Where Code='*20001')*BoxPackRate))*([VAT%]+100))/100 As BillAmount,C.Remarks,BillNo,BillDate,PaidAmount,Status,C.Narration,DNDetails,CNDetails,BillFeedDate,AdjustmentRemarks,C.ComputerName,C.DeliveredQuantityC,C.DeliveredQuantityB,BilledBNC,BilledBNB From BookPOChild08T C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where C.BoxPackRate<>0  " & _
    "Union All  " & _
    "Select C.Code,OrderDate,TargetDate,'1' As ElementGroup,C.BindingType,'*07042' AS BinderyProcess,1 As Number,I.Size As Size,TotalBoxes As Quantity,'*20001' As CalcMode,(Select Value1 From GeneralMaster Where Code='*20001') As CalcValue,CartageRate As Rate,((TotalBoxes/(Select Value1 From GeneralMaster Where Code='*20001')*CartageRate)) As Amount,Adjustment,[VAT%],(((TotalBoxes/(Select Value1 From GeneralMaster Where Code='*20001')*CartageRate))*[VAT%])/100 As VAT,(((TotalBoxes/(Select Value1 From GeneralMaster Where Code='*20001')*CartageRate))*([VAT%]+100))/100 As BillAmount,C.Remarks,BillNo,BillDate,PaidAmount,Status,C.Narration,DNDetails,CNDetails,BillFeedDate,AdjustmentRemarks,C.ComputerName,C.DeliveredQuantityC,C.DeliveredQuantityB,BilledBNC,BilledBNB From BookPOChild08T C INNER JOIN BookPOParent P ON P.Code=C.Code INNER JOIN BookMaster I ON I.Code=P.Book Where C.CartageRate<>0 Or C.Adjustment<>0  " & _
    "Order By Code,BinderyProcess "
End Function
...
'Size Group Update
   cnDatabase.Execute "IF EXISTS (SELECT *FROM GeneralMaster WHERE Code='*10016' OR Name='12.00X18.00 (Digital)') Print 'Exist' ELSE Insert Into GeneralMaster VALUES ('*10016','12.00X18.00 (Digital)','12.00X18.00 (Digital)','10','0','000001',GetDate(),'NULL',NULL,'N','N','NULL')"
'Size Update
...
'Update GeneralMaster (Operation)
   ...
   cnDatabase.Execute "IF EXISTS (SELECT *FROM GeneralMaster WHERE Code='*07044' OR Name='Digital Print_2C') Print 'Exist' ELSE Insert Into GeneralMaster VALUES ('*07044','Digital Print_2C','Digital Print_2C','7','0','000001',GetDate(),'NULL',NULL,'N','N','NULL')"
   cnDatabase.Execute "IF EXISTS (SELECT *FROM GeneralMaster WHERE Code='*07045' OR Name='Digital Print_4C') Print 'Exist' ELSE Insert Into GeneralMaster VALUES ('*07045','Digital Print_4C','Digital Print_4C','7','0','000001',GetDate(),'NULL',NULL,'N','N','NULL')"
'Update GeneralMaster (Element)
   cnDatabase.Execute "IF EXISTS (SELECT Code FROM GeneralMaster WHERE Code='*00020' OR NAME='Cover')  Print 'Exist' ELSE  Update GeneralMaster Set Name='Cover',PrintName='Cover' Where Code='*00020' And Type=19"
   cnDatabase.Execute "IF EXISTS (SELECT Code FROM GeneralMaster WHERE Code='*00027' OR NAME='Title')  Print 'Exist' ELSE  Insert INTO GeneralMaster VALUES('*00027','Title','Title',19,0.000,'000001',GetDate(),'000001',GetDate(),'M','N',NULL)"
'Update ElementMaster (Element)
   cnDatabase.Execute "IF EXISTS (SELECT Code FROM ElementMaster WHERE Code='*00026' OR NAME='Multi Form-1') Print 'Exist' ELSE Insert Into ElementMaster VALUES ('*00026','Multi Form-1','Multi Form-1','Multi Forms','8','0','0','0','000001',GetDate(),'NULL',NULL,'N','N')"
...
''BookPOChild05 Fields Update
'cnDatabase.Execute "IF EXISTS (SELECT *FROM INFORMATION_SCHEMA.COLUMNS WHERE  TABLE_NAME = 'BookPOChild05' AND COLUMN_NAME = 'aTotalPlates1-¼') Print 'Col_Exist' Else Alter Table BookPOChild05 Add [PaperWastage1%] decimal(4, 2) NOT NULL DEFAULT (0),aPaperWastageMin1 smallint NOT NULL DEFAULT (0),[aWastage/Set1] decimal(12, 0) NOT NULL DEFAULT (0),aPaperWastageFinal1 decimal(12, 3) NOT NULL DEFAULT (0),aPaperConsumptionOther1 decimal(12, 3) NOT NULL DEFAULT (0),aPaperConsumptionsheets1 decimal(12, 0) NOT NULL DEFAULT (0),aPaperConsumptionKg1 decimal(12, 3) NOT NULL DEFAULT (0),[aTotalPlates1-¼] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates1-½] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates1-1-F&B] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates1-1-W&T] decimal(12, 0) NOT NULL DEFAULT (0),aRevisedPlates1 decimal(12 DEFAULT (0), 0) NOT NULL DEFAULT (0)"
'cnDatabase.Execute "IF EXISTS (SELECT *FROM INFORMATION_SCHEMA.COLUMNS WHERE  TABLE_NAME = 'BookPOChild05' AND COLUMN_NAME = 'aTotalPlates2-¼') Print 'Col_Exist' Else Alter Table BookPOChild05 Add [aPaperWastage2%] decimal(4, 2) NOT NULL DEFAULT (0),aPaperWastageMin2 smallint NOT NULL DEFAULT (0),[aWastage/Set2] decimal(12, 0) NOT NULL DEFAULT (0),aPaperWastageFinal2 decimal(12, 3) NOT NULL DEFAULT (0),aPaperConsumptionOther2 decimal(12, 3) NOT NULL DEFAULT (0),aPaperConsumptionsheets2 decimal(12, 0) NOT NULL DEFAULT (0),aPaperConsumptionKg2 decimal(12, 3) NOT NULL DEFAULT (0),[aTotalPlates2-¼] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates2-½] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates2-1-F&B] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates2-1-W&T] decimal(12, 0) NOT NULL DEFAULT (0),aRevisedPlates2 decimal(12 DEFAULT (0), 0) NOT NULL DEFAULT (0)"
'cnDatabase.Execute "IF EXISTS (SELECT *FROM INFORMATION_SCHEMA.COLUMNS WHERE  TABLE_NAME = 'BookPOChild05' AND COLUMN_NAME = 'aTotalPlates4-¼') Print 'Col_Exist' Else Alter Table BookPOChild05 Add [aPaperWastage4%] decimal(4, 2) NOT NULL DEFAULT (0),aPaperWastageMin4 smallint NOT NULL DEFAULT (0),[aWastage/Set4] decimal(12, 0) NOT NULL DEFAULT (0),aPaperWastageFinal4 decimal(12, 3) NOT NULL DEFAULT (0),aPaperConsumptionOther4 decimal(12, 3) NOT NULL DEFAULT (0),aPaperConsumptionsheets4 decimal(12, 0) NOT NULL DEFAULT (0),aPaperConsumptionKg4 decimal(12, 3) NOT NULL DEFAULT (0),[aTotalPlates4-¼] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates4-½] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates4-1-F&B] decimal(12, 0) NOT NULL DEFAULT (0),[aTotalPlates4-1-W&T] decimal(12, 0) NOT NULL DEFAULT (0),aRevisedPlates4 decimal(12 DEFAULT (0), 0) NOT NULL DEFAULT (0)"
''BookPOChild05 Actual Plates Update
'cnDatabase.Execute "IF Not EXISTS (SELECT *FROM INFORMATION_SCHEMA.COLUMNS WHERE  TABLE_NAME = 'BookPOChild05' AND COLUMN_NAME = 'aPaperWastage1%') Print 'Col_Exist' Else Update BookPOChild05 Set [TotalPlates1-¼][aTotalPlates1-¼] ,[TotalPlates1-½] = [aTotalPlates1-½],Convert(INT,Convert(INT,([TotalPlates1-1]/1/2))*2*1) = [aTotalPlates1-1-F&B],Convert(INT,[TotalPlates1-1]*1- Convert(INT,([TotalPlates1-1]/1/2))*2*1) = [aTotalPlates1-1-W&T],RevisedPlates1*1 = aRevisedPlates"
''BookPOChild05 Actual Wastage Update
''[PaperWastage1%] = [aPaperWastage%],[PaperWastageMin1] = [aPaperWastageMin],(Select (((PARSENAME(PaperWastageFinal1,2)*U.Value1)+(PARSENAME(PaperWastageFinal1,1)))/(Forms1)) From GeneralMaster U INNER JOIN PaperMaster P1 ON U.Code=P1.UOM Where C.Paper1=P1.Code) = [aWastage/Set],[PaperWastageFinal1] = [aPaperWastageFinal],[PaperConsumptionOther1] = [aPaperConsumptionOther],[PaperConsumptionsheets1] = [aPaperConsumptionsheets],(SELECT ROUND(([Weight/Unit]/U.Value1)*[PaperConsumptionsheets1],3) FROM PaperMaster R INNER JOIN GeneralMaster U ON R.UOM=U.Code WHERE R.Code=Paper1) = [aPaperConsumptionKg]
'
''BookPOChild06 Fields Update
...
''BookPOChild06 Actual Plates Update
'cnDatabase.Execute "IF Not EXISTS (SELECT *FROM INFORMATION_SCHEMA.COLUMNS WHERE  TABLE_NAME = 'BookPOChild06' AND COLUMN_NAME = 'aPaperWastage%') Print 'Col_Not_Exist' Else Update BookPOChild06 Set TotalPlates = aTotalPlates,TotalPlatesBack = aTotalPlatesBack Where aTotalPlates=0"
