...
Private Sub PrintMaterialStockRegister()
    ...
    If ReportType = "1" Then
        ...
        OutsourceItemQuantity = "(SELECT IIF(ISNULL(SUM(OpBal)),0,SUM(OpBal)) FROM AccountChild0801 WHERE Category=C.Category AND Item=C.Item AND Code=A.Code)+" & _
                                                  ...
                                                  "(SELECT IIF(ISNULL(SUM(Round(I.TotalConsumption,0))),0,SUM(Round(I.TotalConsumption,0))) FROM BookPOParent M,BookPOChild0801 I WHERE M.Code=I.Code AND LEFT(M.Type,1)<>'O' AND LEFT(M.Code,1)<>'*' AND Category=C.Category AND Item=C.Item AND I.Vendor=A.Code AND Date<#" & GetDate(MhDateInput1.Text) & "#)"
        ...
        RepairBookQuantity = "(SELECT IIF(ISNULL(SUM(OpBal)),0,SUM(OpBal)) FROM AccountChild0801 WHERE Category='4' AND Item=O.Code AND Code=A.Code)+" & _
                                            ...
                                            "(SELECT IIF(ISNULL(SUM(Round(I.TotalConsumption,0))),0,SUM(Round(I.TotalConsumption,0))) FROM BookPOParent M,BookPOChild0801 I WHERE M.Code=I.Code AND LEFT(M.Type,1)<>'O' AND LEFT(M.Code,1)<>'*' AND Category='4' AND Item=O.Code AND I.Vendor=A.Code AND Date<#" & GetDate(MhDateInput1.Text) & "#)"
        TitleQuantity = "(SELECT IIF(ISNULL(SUM(OpBal)),0,SUM(OpBal)) FROM AccountChild0801 WHERE Category='5' AND Item=O.Code AND Code=A.Code)+" & _
                                 ...
                                 "(SELECT IIF(ISNULL(SUM(Round(I.TotalConsumption,0))),0,SUM(Round(I.TotalConsumption,0)))  FROM BookPOParent M,BookPOChild0801 I WHERE M.Code=I.Code AND LEFT(M.Type,1)<>'O' AND LEFT(M.Code,1)<>'*' AND Category='5' AND Item=O.Code AND I.Vendor=A.Code AND Date<#" & GetDate(MhDateInput1.Text) & "#)"
    ...
    Else
        ...
        Else
            OutsourceItemQuantity = "(SELECT IIF(ISNULL(SUM(OpBal)),0,SUM(OpBal)) FROM AccountChild0801 WHERE Category='1' AND Item=O.Code AND Code=A.Code)+" & _
                                                      ...
                                                      "(SELECT IIF(ISNULL(SUM(Round(I.TotalConsumption,0))),0,SUM(Round(I.TotalConsumption,0)))  FROM BookPOParent M,BookPOChild0801 I WHERE M.Code=I.Code AND LEFT(M.Type,1)<>'O' AND LEFT(M.Code,1)<>'*' AND Category='1' AND Item=O.Code AND I.Vendor=A.Code AND Date<#" & GetDate(MhDateInput1.Text) & "#)"
        End If
     If DatabaseType = "MS SQL" Then OutsourceItemQuantity = Replace(OutsourceItemQuantity, "#", "'")
        ...
        ElseIf Val(ListView1.SelectedItem.SubItems(1)) = 3 Then
            FreshBookQuantity = "(SELECT IIF(ISNULL(SUM(OpBal)),0,SUM(OpBal)) FROM AccountChild0801 WHERE Category='3' AND Item=O.Code AND Code=A.Code)+" & _
                                               ...
                                               "(SELECT IIF(ISNULL(SUM(Round(I.TotalConsumption,0))),0,SUM(Round(I.TotalConsumption,0)))  FROM BookPOParent M,BookPOChild0801 I WHERE M.Code=I.Code AND LEFT(M.Type,1)<>'O' AND LEFT(M.Code,1)<>'*' AND Category='3' AND Item=O.Code AND I.Vendor=A.Code AND Date<#" & GetDate(MhDateInput1.Text) & "#)"
