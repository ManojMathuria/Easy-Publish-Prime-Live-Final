...
Begin VB.Form FrmProductionScheduling 
   ...
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame2 
      ...
      Begin FPSpreadADO.fpSpread fpSpread1 
         ...
         SpreadDesigner  =   "ProductionScheduling.frx":036A
      End
      ...
      Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
         ...
         FormatString    =   ""
         Caption         =   ""
         Picture         =   "ProductionScheduling.frx":17B7
         Begin Mh3dlblLib.Mh3dLabel Mh3dLabel17 
            ...
            FillColor       =   9164542
            TextColor       =   0
            Picture         =   "ProductionScheduling.frx":17D3
            Picture         =   "ProductionScheduling.frx":17EF
         End
      ...
      Begin VB.CommandButton cmdFilter 
         Height          =   320
         Left            =   6720
         Picture         =   "ProductionScheduling.frx":180B
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Filter"
         Top             =   8760
      ...
      Begin VB.CommandButton Command2 
         Height          =   320
         Left            =   7200
         Picture         =   "ProductionScheduling.frx":1B4D
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Search"
         Top             =   8760
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel2 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":1E8F
         Picture         =   "ProductionScheduling.frx":1EAB
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel3 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":1EC7
         Picture         =   "ProductionScheduling.frx":1EE3
      End
      Begin TDBDate6Ctl.TDBDate MhDateInput2 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "ProductionScheduling.frx":1EFF
         Caption         =   "ProductionScheduling.frx":2017
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "ProductionScheduling.frx":2083
         Keys            =   "ProductionScheduling.frx":20A1
         Spin            =   "ProductionScheduling.frx":20FF
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   16777215
      ...
      Begin TDBDate6Ctl.TDBDate MhDateInput1 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "ProductionScheduling.frx":2127
         Caption         =   "ProductionScheduling.frx":223F
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "ProductionScheduling.frx":22AB
         Keys            =   "ProductionScheduling.frx":22C9
         Spin            =   "ProductionScheduling.frx":2327
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   16777215
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":234F
         Picture         =   "ProductionScheduling.frx":236B
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel4 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":2387
         Picture         =   "ProductionScheduling.frx":23A3
      End
      Begin TDBNumber6Ctl.TDBNumber TDBNumber2 
         ...
         _ExtentX        =   2143
         _ExtentY        =   582
         Calculator      =   "ProductionScheduling.frx":23BF
         Caption         =   "ProductionScheduling.frx":23DF
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "ProductionScheduling.frx":2443
         Keys            =   "ProductionScheduling.frx":2461
         Spin            =   "ProductionScheduling.frx":24AB
         AlignHorizontal =   2
         AlignVertical   =   0
         Appearance      =   1
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel5 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":24D3
         Picture         =   "ProductionScheduling.frx":24EF
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel6 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":250B
         Picture         =   "ProductionScheduling.frx":2527
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel7 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":2543
         Picture         =   "ProductionScheduling.frx":255F
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel8 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":257B
         Picture         =   "ProductionScheduling.frx":2597
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel 
         ...
         FillColor       =   8421504
         TextColor       =   16777215
         Picture         =   "ProductionScheduling.frx":25B3
         Picture         =   "ProductionScheduling.frx":25CF
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel9 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":25EB
         Picture         =   "ProductionScheduling.frx":2607
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel11 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":2623
         Picture         =   "ProductionScheduling.frx":263F
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel12 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":265B
         Picture         =   "ProductionScheduling.frx":2677
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel15 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":2693
         Picture         =   "ProductionScheduling.frx":26AF
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel16 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ProductionScheduling.frx":26CB
         Picture         =   "ProductionScheduling.frx":26E7
      End
      Begin TDBTime6Ctl.TDBTime TDBTime4 
         ...
         _ExtentX        =   1296
         _ExtentY        =   582
         Caption         =   "ProductionScheduling.frx":2703
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         Keys            =   "ProductionScheduling.frx":2767
         Spin            =   "ProductionScheduling.frx":27B7
         AlignHorizontal =   2
         AlignVertical   =   2
         Appearance      =   1
         BackColor       =   -2147483643
      ...
      Begin TDBTime6Ctl.TDBTime TDBTime5 
         ...
         _ExtentX        =   1296
         _ExtentY        =   582
         Caption         =   "ProductionScheduling.frx":27DF
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         Keys            =   "ProductionScheduling.frx":2843
         Spin            =   "ProductionScheduling.frx":2893
         AlignHorizontal =   2
         AlignVertical   =   2
         Appearance      =   1
         BackColor       =   -2147483643
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ProductionScheduling.frx":28BB
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ProductionScheduling.frx":2DFF
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ProductionScheduling.frx":2F13
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "ProductionScheduling.frx":3025
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private Sub Form_Load()
    ...
    Combo4.ListIndex = 2
    If VchType = 2 Then Combo4.Visible = True: Mh3dLabel18.Visible = True
    Reset = 1
...
fpSpread1.ColHeadersAutoText = DispBlank
  ...
  SQL = "SELECT (Select Name From ElementMaster Where Code='*00011') As Element,RIGHT(P.Type,1)+'O/'+IIF(LEFT(P.Type,1)='F','FG-MF','UFG-MF')+'/'+LTRIM(P.Name) As RefNo,P.Date As RefDate,I.Name As Item,S.Name As [Size],'1' As Col,A.Name As Party,C.Forms1 As TotalForms,ISNULL(C1.[Plan],C.Forms1) AS [Plan],ISNULL(C1.formsPrinted,0) AS formsPrinted,C.ActualQuantity As TotalQty,(P.DeliveredQuantityC+P.DeliveredQuantityB) As QtyIssued,IIF(PlateType1='1','Deepatch',IIF(PlateType1='2','PS',IIF(PlateType1='3','Wipeon','CTP'))) As Plate,IIF(Processing='N',[TotalPlates1-¼]+[TotalPlates1-½]+[TotalPlates1-1]+[RevisedPlates1],IIF(Processing='O',0,[RevisedPlates1])) As TotalPlates,ISNULL(C1.platesIssued,0) AS platesIssued, LTRIM(R.Name) As Paper,PARSENAME(PaperWastageFinal1,2)*U.Value1+(PARSENAME(PaperWastageFinal1,1)) As Wastage,PaperConsumptionsheets1 As TotalPaper,ISNULL(C1.paperIssued,0) As paperIssued,P.Code+'MF1*00011' As RefCode,M.Name AS MAC,M.Code AS MCode,MakeReadyTime,Efficiency,ISNULL(C1.SNo,0) AS SNo, " & _
    ...
    SQL = SQL + " UNION " & _
              ...
              " AND " & IIf(Combo4.ListIndex = 0, "C.Processing='N'", IIf(Combo4.ListIndex = 1, "C.Processing='O'", "1=1")) & " AND " & IIf(Option2.Value, "(C.ActualQuantity-P.DeliveredQuantityC+P.DeliveredQuantityB)>0", "(C.ActualQuantity-P.DeliveredQuantityC+P.DeliveredQuantityB)<=0") & "AND " & Choose(Combo1.ListIndex + 1, "RIGHT(P.Type,1)='S'", "RIGHT(P.Type,1)='P'", "1=1") & " AND " & IIf(Check2.Value = 0, "C1.Machine IS NOT NULL", IIf(MC = "All", "1=1", "(ISNULL(C1.Machine,'*21046') IN ('" & MC & "','*21046') OR " & IIf(Check2.Value, "(C1.Machine IS NULL)", "C1.Machine IN ('')") & ")")) & " AND " & IIf(Check2.Value = 0, "M.Code<>'*21046'", "1=1") & " AND " & IIf(VchType = 2 And Option1.Value, "1=1", IIf(VchType = 2 And Option2.Value, "C1.[Plan]-ISNULL(C1.platesIssued,0)<>0", IIf(VchType = 2 And Option3.Value, "C1.[Plan]-ISNULL(C1.platesIssued,0)=0", "1=1"))) & " AND " & IIf(Check2.Value, "1=1", IIf(MC = "All", "1=1", "M.Code <>'*21046'"))
    'MF2
    SQL = SQL + " UNION " & _
              "SELECT Distinct (Select Name From ElementMaster Where Code='*00012') As Element," & _
              "RIGHT(P.Type,1)+'O/'+IIF(LEFT(P.Type,1)='F','FG-MF','UFG-MF')+'/'+LTRIM(P.Name) As RefNo,P.Date As RefDate,I.Name As Item,S.Name As [Size],'2' As Col,A.Name As Party,C.Forms2 As TotalForms,C.Forms2-ISNULL((Select Sum ([Plan]) From BookPOChild0501 Where Code=P.Code+'MF2*00012'),0) AS [Plan],0  AS formsPrinted,C.ActualQuantity As TotalQty,(P.DeliveredQuantityC+P.DeliveredQuantityB) As QtyIssued,IIF(PlateType2='1','Deepatch',IIF(PlateType2='2','PS',IIF(PlateType2='3','Wipeon','CTP'))) As Plate,IIF(Processing='N',[TotalPlates2-¼]+[TotalPlates2-½]+[TotalPlates2-1]+[RevisedPlates2],IIF(Processing='O',0,[RevisedPlates2])) As TotalPlates,0 AS platesIssued,LTRIM(R.Name) As Paper,PARSENAME(PaperWastageFinal2,2)*U.Value1+(PARSENAME(PaperWastageFinal2,1)) As Wastage,PaperConsumptionsheets2 As TotalPaper,ISNULL(C1.paperIssued,0) As paperIssued,P.Code+'MF2*00012' As RefCode,M.Name AS MAC,M.Code AS MCode,MakeReadyTime,Efficiency,0 AS SNo, " & _
    ...
    SQL = SQL + " UNION " & _
              ...
              " AND " & IIf(Combo4.ListIndex = 0, "C.Processing='N'", IIf(Combo4.ListIndex = 1, "C.Processing='O'", "1=1")) & " AND " & Choose(Combo1.ListIndex + 1, "RIGHT(P.Type,1)='S'", "RIGHT(P.Type,1)='P'", "1=1") & " AND " & IIf(Check2.Value = 0, "C1.Machine IS NOT NULL", IIf(MC = "All", "1=1", "(ISNULL(C1.Machine,'*21046') IN ('" & MC & "','*21046') OR " & IIf(Check2.Value, "(C1.Machine IS NULL)", "C1.Machine IN ('')") & ")")) & " AND " & IIf(Check2.Value = 0, "M.Code<>'*21046'", "1=1") & " AND " & IIf(VchType = 2 And Option1.Value, "1=1", IIf(VchType = 2 And Option2.Value, "C1.[Plan]-ISNULL(C1.platesIssued,0)<>0", IIf(VchType = 2 And Option3.Value, "C1.[Plan]-ISNULL(C1.platesIssued,0)=0", "1=1"))) & " AND " & IIf(Check2.Value, "1=1", IIf(MC = "All", "1=1", "M.Code <>'*21046'"))
    'CF
    SQL = SQL + " UNION " & _
             "SELECT Distinct (Select Name From ElementMaster Where Code='*00015') As Element," & _
             "RIGHT(P.Type,1)+'O/'+IIF(LEFT(P.Type,1)='F','FG-CF','UFG-CF')+'/'+LTRIM(P.Name) As RefNo,P.Date As RefDate,I.Name As Item,S.Name As [Size],Convert(nvarchar,C.FrontPrintingColor)+Convert(nvarchar,C.BackPrintingColor) As Col,A.Name As Party,1 As TotalForms,1-ISNULL((Select Sum ([Plan]) From BookPOChild0501 Where Code=P.Code+'CF1*00015'),0) AS [Plan],ISNULL(0,0) AS formsPrinted,C.ActualQuantity As TotalQty,(P.DeliveredQuantityC+P.DeliveredQuantityB) As QtyIssued,IIF(PlateType='1','Deepatch',IIF(PlateType='2','PS',IIF(PlateType='3','Wipeon','CTP'))) As Plate,IIF(Plate='N',(C9.FrontPrintingColor)+(C9.BackPrintingColor),IIF(Plate='O',0,0)) As TotalPlates,0 AS PlatesIssued,LTRIM(R.Name) As Paper, PARSENAME(PaperWastageFinal,2)*U.Value1+(PARSENAME(PaperWastageFinal,1)) As Wastage,PaperConsumptionsheets As TotalPaper,ISNULL(C1.paperIssued,0) AS paperIssued,P.Code+'CF1*00015' As RefCode,M.Name AS MAC,M.Code AS MCode,MakeReadyTime,Efficiency,0 AS SNo," & _
             "M.StartTime,M.EndTime,1-ISNULL((Select Sum ([Plan]) From BookPOChild0501 Where Code=P.Code+'CF1*00015'),0) AS PendingPlan,C.Plate As Processing FROM (((((((BookPOParent P INNER JOIN BookPOChild09 C ON P.Code=C.Code)INNER JOIN BookPOChild0901 C9 ON C.Code=C9.Code) INNER JOIN BookMaster I ON P.Book=I.Code) INNER JOIN GeneralMaster S ON C.[Size]=S.Code) INNER JOIN PaperMaster R ON C.Paper=R.Code) INNER JOIN GeneralMaster U ON R.UOM=U.Code) LEFT JOIN BookPOChild0501 C1 ON C.Code+'CF1*00015'=C1.Code) LEFT JOIN AccountMaster A ON P.TitlePrinter=A.Code LEFT JOIN MachineMaster M ON M.Code=('*21046') WHERE (" & IIf(MC = "All", "1=1", "(Select Units From MachineMaster Where Code='" & MC & "')>= LTRIM(C.FrontPrintingColor)") & "  OR " & IIf(MC = "All", "1=1", "(Select Units From MachineMaster Where Code='" & MC & "')>= LTRIM(C.BackPrintingColor)") & " ) AND LEFT(P.Type,1)<>'O' AND P.Date>='" & GetDate(MhDateInput1.Text) & "' AND P.Date<='" & GetDate(MhDateInput2.Text) & "' AND " & _
              ...
              " AND " & IIf(VchType = 2 And Option1.Value, "1=1", IIf(VchType = 2 And Option2.Value, "C1.[Plan]-ISNULL(C1.platesIssued,0)<>0", IIf(VchType = 2 And Option3.Value, "C1.[Plan]-ISNULL(C1.platesIssued,0)=0", "1=1"))) & " AND " & IIf(Check2.Value, "1=1", "M.Code <>'*21046'") & _
