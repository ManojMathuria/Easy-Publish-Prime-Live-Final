...
Dim rstItemList As New ADODB.Recordset, rstItemChild As New ADODB.Recordset, rstMemberList As New ADODB.Recordset
    ...
    With fpSpread3
        For i = 1 To .DataRowCnt
            ...
            If Not CheckEmpty(Remarks, False) Then
                ...
                If (Not IsDate(GetDate(TargetDate))) Or Format(TargetDate, "yyyymmdd") < Format(AssignedON, "yyyymmdd") Then CheckItem = True: Col = 5: GoTo Err
                'Start Date
                If Len(StartDate) < 10 Then CheckItem = True: Col = 6: GoTo Err
                If (Not IsDate(GetDate(StartDate))) Or Format(StartDate, "yyyymmdd") < Format(AssignedON, "yyyymmdd") Then CheckItem = True: Col = 6: GoTo Err
            End If
            Exit Function
Err:
