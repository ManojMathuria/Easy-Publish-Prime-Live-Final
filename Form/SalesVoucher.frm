...
Private Sub PushVch()
    ...
    With rstSalesVoucherChild
        ...
        xmlstr = "SELECT LTRIM(H.Name) As BillNo,H.Date As BillDate,M.PrintName As MatCentre," + _
                        ...
                        "I.ItemIntegrationName As Item,I.BusyCode As ItemAlias,D.Rate,D.[Disc%],D.Quantity,D.Amount,H.Name As DeliveryNoteNo,H.GRNo As DispatchDocNo,H.Transport As DishpatchThrough,H.Station As Destination,H.Transport As [CarrierName/Agent],H.GRNo As [BillofLoading/LR-RRNO],H.GRDate,H.VehicleNo As MotorVehicleNo,H.eWayBill,H.eWayBillDate,IIF((Select Name From AccountMaster Where Code=H.SalesType)='Sales','Bill of Supply','Bill of Supply') As DocType,'Supply' As SubType,'Generated by me' As BILLSTATUS " & _
